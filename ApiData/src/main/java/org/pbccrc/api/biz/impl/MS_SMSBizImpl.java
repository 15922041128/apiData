...
/** 短信服务接口(美圣实现) */
@Service("ms_smsBiz")
public class MS_SMSBizImpl implements SMSBiz{
	
	//账号
	static String account = "JSM41444";
	//密码
	static String password = "5c3q3ogs";
	//校验码
	static String veryCode = "samkw8sdrgmg";
	//接口地址
	...
	public void query(String phoneNo, String vCode) throws Exception {
		...
		sb.append("@1@=" + vCode);
		sb.append(",@2@=1");
		sendTplSms(phoneNo,"JSM41444-0002", sb.toString());
	}
